...
/**
 * A Consumer which will publish to a RabbitMQUtils Topic
 * <p>
 *
               ...
               BiConsumer<AMQP.BasicProperties, byte[]>
{
    ...
    public RabbitConsumer( RabbitConnection connection,
                           String routingKey )
    {
        this( connection,
              RabbitMQUtils.DEFAULT_TOPIC,
              routingKey );
    }
    ...
    @Override
    public synchronized void accept( AMQP.BasicProperties props,
                                     byte[] t )
    {
        if ( t != null )
        {
            for ( int attempt = 0; attempt < ATTEMPTS; attempt++ )
            {
                ...
                catch ( IOException | UncheckedIOException ex )
                {
                    LOG.log( Level.SEVERE,
                             "On topic " + topic + " routing " + routingKey,
                             ex );
                    connection.close( );
                }
            }
    ...
    public boolean equals( Object obj )
    {
        ...
        return Objects.equals( this.topic,
                               other.topic ) || Objects.equals( this.routingKey,
                                                                other.routingKey );
    }
