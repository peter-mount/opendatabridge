...
public class CollectionUtils
{
    ...
    {
        Objects.requireNonNull( values );
        return Collections.unmodifiableSet( EnumSet.<E>of( values[ 0 ],
     ...
     */
    public static <K, V> void replace( Map<K, V> map,
     ...
     * @param c   Consumer
     */
    public static <K, V> void ifPresent( Map<? extends K, ? extends V> m,
                                         K k,
                                         Consumer<V> c )
    {
        V v = m.get( k );
     ...
     * @param c   Consumer
     */
    public static <K, V> void ifAbsent( Map<? extends K, ? extends V> m,
                                        K k,
                                        Consumer<K> c )
    {
        if ( !m.containsKey( k ) )
    ...
    public static <K, V> void ifAbsent( Map<? extends K, ? extends V> m,
                                        K k,
                                        BiConsumer<Map<? extends K, ? extends V>, K> c )
    {
        if ( !m.containsKey( k ) )
        {
            c.accept( m,
     ...
     * @return Consumer
     */
    public static <T, K, V> Consumer<T> consumeIfPresent( Map<? extends K, ? extends V> m,
                                                          Function<T, K> kMapper,
                                                          Consumer<V> c )
    {
        return t -> ifPresent( m,
                               kMapper.apply( t ),
                               c );
    }
     ...
     * @return Consumer
     */
    public static <T, K, V> Consumer<T> consumeIfAbsent( Map<? extends K, ? extends V> m,
                                                         Function<T, K> kMapper,
                                                         Consumer<K> c )
    {
        return t -> ifAbsent( m,
    ...
    public static <T> void forEach( Collection<T> col,
                                    Consumer<T> c )
    {
