...
public final class Consumers
{
     ...
     */
    public static <C extends Consumer<T>, T> C createIf( boolean condition,
                                                         Supplier<C> s )
    {
    ...
    /**
     * Create a consumer if some object is not null, null if false
     * <p>
     *
     * @param <C>
     * @param <T> type
     * @param obj object to check for non-null
     * @param s   supplier
     *            <p>
     *
     * @return Consumer or null
     */
    public static <C extends Consumer<T>, T> C createIfNotNull( Object obj,
                                                                Supplier<C> s )
    {
        return createIf( obj != null,
                         s );
    }
     ...
     */
    public static <F, T> Consumer<F> transform( Consumer<T> c,
                                                Function<F, T> f )
    {
     ...
     * @return
     */
    public static <T> Consumer<T> ifThen( Predicate<T> p,
                                          Consumer<T> t )
    {
     ...
     * @return
     */
    public static <T> Consumer<T> ifNotThen( Predicate<T> p,
                                             Consumer<T> f )
    {
        Objects.requireNonNull( p );
        Objects.requireNonNull( f );
        return ifThen( p.negate( ),
                       f );
    }
     ...
     * @return
     */
    public static <T> Consumer<T> ifThenElse( Predicate<T> p,
                                              Consumer<T> t,
                                              Consumer<T> f )
    {
        Objects.requireNonNull( p );
    ...
    public static <T, U> Consumer<T> consume( Function<T, U> f,
                                              Consumer<U> c )
    {
    ...
    public static <T, U> Consumer<T> consumeIfNotNull( Function<T, U> f,
                                                       Consumer<U> c )
    {
        return t -> {
            if ( t != null )
     ...
     * @return consumer
     */
    public static Consumer<String> log( Logger logger,
                                        Level level )
    {
        Objects.requireNonNull( logger );
        Objects.requireNonNull( level );
        return s -> logger.log( level,
                                s );
    }
     ...
     * @return consumer
     */
    public static Consumer<String> log( String name,
                                        Level level )
    {
     ...
     * @return consumer
     */
    public static Consumer<String> log( Class clazz,
                                        Level level )
    {
     ...
     * <ol>
     * <li>if a is null then this returns b</li>
     * <li>if b is null then this returns a</li>
     ...
     */
    public static <T> Consumer<T> andThen( Consumer<T> a,
                                           Consumer<T> b )
    {
    ...
    public static <T> Consumer<T> andThenGuarded( Consumer<T> a,
                                                  Consumer<T> b )
    {
        return andThen( a,
                        guard( b ) );
     ...
     * @return
     */
    public static <T> Consumer<T> andThenGuarded( Logger log,
     ...
     * @return
     */
    public static <T> Consumer<T> andThenGuarded( String name,
                                                  Consumer<T>... consumers )
    {
        Objects.requireNonNull( name );
        return andThenGuarded( Logger.getLogger( name ),
                               consumers );
    }
     ...
     * @return
     */
    public static <T> Consumer<T> andThenGuarded( Class clazz,
                                                  Consumer<T>... consumers )
    {
        Objects.requireNonNull( clazz );
        return andThenGuarded( clazz.getName( ),
                               consumers );
    }
     ...
     * @return new Consumer
     */
    public static <T> Consumer<T> guard( Logger log,
                                         Consumer<T> c )
    {
        Objects.requireNonNull( log );
        Objects.requireNonNull( c );
        return v -> {
            ...
            catch ( Throwable t )
            {
                log.log( Level.SEVERE,
                         "Exception thrown by consumer " + c,
                         t );
            }
        };
    }
     ...
     * @return new Consumer
     */
    public static <T> Consumer<T> guard( String name,
                                         Consumer<T> c )
    {
        Objects.requireNonNull( name );
        return guard( Logger.getLogger( name ),
                      c );
    }
     ...
     * @return new Consumer
     */
    public static <T> Consumer<T> guard( Class clazz,
                                         Consumer<T> c )
    {
        Objects.requireNonNull( clazz );
        return guard( clazz.getName( ),
                      c );
    }
     ...
     * @return Consumer
     */
    public static <T> Consumer<T> fork( Executor e,
                                        Consumer<T> c )
    {
    ...
    {
        return Consumers.fork( DaemonThreadFactory.INSTANCE.getCachedExecutor( ),
                               c );
    }
    ...
    {
        return Consumers.fork( DaemonThreadFactory.INSTANCE.getWorkExecutor( ),
                               c );
    }
     ...
     * @return new consumer
     */
    public static <T> Consumer<T> executeWith( Executor e,
                                               Consumer<T> c )
    {
